...
/**
 * CarRepairShop implementa una aplicació que permiteix donar d'alta a clients, mecanics, vehicles i
 * reparacions novas en un taller de mecanics
 * URL del repositori: https://github.com/ViictorTrujG/CairRepairShop
...
public class CarRepairShop {
    ...
    // Matrius principals de la aplicació
    ...
    // Métode principal para inicialitzar la aplicació
    public static void main(String[] args) {

        CarRepairShop main = new CarRepairShop();
        main.init();
    }

    public void init(){
        int menuItem = 0; // Inicialitza la opció de la aplicació
        do {
        ...
        }while (menuItem!=6); // Limit de numero de opcions
